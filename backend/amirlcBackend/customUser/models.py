...
class User(AbstractUser):
    ...
    other_email = models.EmailField(max_length=500, blank=True, null=True)
...
# Set unique related_name attributes
User._meta.get_field('groups').remote_field.related_name = 'custom_user_groups'
User._meta.get_field(
    'user_permissions').remote_field.related_name = 'custom_user_user_permissions'
